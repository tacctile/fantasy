...
| [te-alignment-rate](te-alignment-rate.md) | Share of TE snaps inline vs. slot/wide — a role-deployment signal that mediates opportunity through route participation, not a direct target predictor; motion classification is the main provider disagreement. | medium |
| [college-dominator-breakout-age](college-dominator-breakout-age.md) | College receiver's share of team receiving production and the age it was first achieved — a WR-primary prospect signal; threshold (20-30%) and competition-level adjustment are unstandardized; weaker for TE/RB. | medium |
| [athletic-testing](athletic-testing.md) | RAS, Speed Score, and Burst Score — position-relative composites from combine/pro day testing; measure physical ceiling, not football skill; best used as a tiebreaker subordinate to production and draft capital. | medium |
