...
/**
 * Route-segment loading skeleton for the league dashboard. Mirrors the shell's
 * real layout — a slim league-identity header (the selector and sign-out live
 * in the persistent sidebar now, not this page), week-selector row, two-column
 * matchup cards, then standings and power rankings side-by-side — so the swap
 * to live content doesn't reflow. Pure CSS pulse (Animation Governance: no rAF
...
export default function LeagueDashboardLoading() {
  return (
    ...
    >
      ...
      {/* Header: league name + platform badge + season only */}
